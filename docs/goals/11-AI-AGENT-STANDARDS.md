...
|--------|--------|--------|
| CLAUDE.md | ✅ | Подробный, покрывает архитектуру и правила |
| Структура проекта задокументирована | ✅ | STRUCTURE.md |
| Архитектурные решения задокументированы | ✅ | docs/architecture/ |
| Тестовые команды | ✅ | В CLAUDE.md и MEMORY.md |
| Security constraints для agent | ⚠️ Частично | Есть базовые правила, нет AI-специфичных |
| Context boundaries | 🔴 Нет | Agent не знает что менять нельзя |
...
### Phase 0.7 (текущая) — Baseline

- [x] CLAUDE.md содержит правила для coding agents
- [ ] Добавить AI-safety раздел в CLAUDE.md (CA-1)
- [ ] Определить "не трогать" зоны (CA-2)
