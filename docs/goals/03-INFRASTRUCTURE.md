...
### Кэширование
- [ ] 🔴 Redis кэширование: course list, course by id, curriculum (Phase 1.1)
...
> **Текущее состояние:** Redis сконфигурирован в Docker Compose (dev + prod), подключён к каждому сервису через `redis_url` в `BaseAppSettings`, но пока не используется для кэширования.
